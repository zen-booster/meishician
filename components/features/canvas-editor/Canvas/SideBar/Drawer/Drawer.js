...
function Drawer({ closeDrawer, buttonName }) {
  return (
    <div className="absolute top-0 left-full flex h-full w-80 flex-col items-center bg-gray-100">
      <div className="mb-4 flex w-full items-center justify-between px-5 py-5 text-lg">
